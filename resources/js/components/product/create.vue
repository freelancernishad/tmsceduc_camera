									...
									<div class="form-group">
										<div class="form-row">
                                            ...
                                            <div class="col-md-6">
												...
												<input type="text" class="form-control" id="exampleInputPhone" placeholder="Enter Brand" v-model='form.root'>
												<small class="text-danger" v-if="errors.root">{{ errors.root[0] }}</small>
											</div>
<!--
                                            <div class="col-md-4">
                                                <label for="exampleFormControlSelect1">Buying Company</label>
												<input type="text" class="form-control" id="exampleInputPhone" placeholder="Enter BuyingCompany" v-model='form.BuyingCompany'>
												<small class="text-danger" v-if="errors.BuyingCompany">{{ errors.BuyingCompany[0] }}</small>
											</div> -->
										</div>
									</div>
									<div class="form-group">
									...
									<div class="form-group">
										...
										<div class="form-row">
											...
											<div class="col-md-4">
                                                <label for="">Warranty last Date</label>
												<input type="date" class="form-control" id="exampleInputAddress" placeholder="Enter Warranty last Date" v-model='form.expired_date'>
